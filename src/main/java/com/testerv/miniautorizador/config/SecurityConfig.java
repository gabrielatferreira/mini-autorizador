...
/**
 * Configuração de segurança da aplicação com Basic Authentication.
 * As rotas de documentação (Swagger/OpenAPI) são ignoradas pela segurança para evitar
 * conflitos de carregamento de recursos estáticos e loopings de redirecionamento.
 */
@Slf4j
@Configuration
@EnableWebSecurity
